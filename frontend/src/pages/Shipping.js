          ...
          <Card className="border-0 bg-gray-50">
            <CardContent className="p-8">
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  <Shield className="h-6 w-6 text-[#6B7280] mt-1 flex-shrink-0" />
                  <div>
        ...
        <div className="bg-[#0B0B0B] text-white p-8 md:p-12 rounded-lg">
          <div className="text-center">
            ...
            <Button 
              onClick={handleWhatsAppContact}
              size="lg"
              className="bg-[#6B7280] hover:bg-[#4B5563] text-white text-lg px-8 py-6 transition-colors duration-300"
            >
